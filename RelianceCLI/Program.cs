        ...
        private struct Options
        {
                ...
                foreach (var str in args)
                {
                    ...
                    else
                    {
                        switch (str)
                        {
                            ...
                            case "--reconnection-test":
                                opts.ReconnectionTest = true;
                                break;
            ...
            public static string Usage()
            {
                return "\nPyramid Technologies Inc (c) 2018\n" +
                       ...
                       "\t--reconnection-test\t\tDisconnection/Reconnection recovery test\n" +
